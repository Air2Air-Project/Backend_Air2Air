...
CREATE TABLE `alert` (
  ...
  KEY `fk_region_id2_idx` (`region_id`),
  CONSTRAINT `fk_region_id2` FOREIGN KEY (`region_id`) REFERENCES `region` (`region_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='after answer, questionboard''s is_answered is true';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `answer_board` VALUES (3,'수정 완료된 답변입니다.','2024-07-06 06:41:12',2,3),(7,'문의 주셔서 감사합니다. 그 내용에 관해서는 어쩌구 저쩌구..','2024-07-12 09:27:39',2,15);
...
INSERT INTO `region` VALUES (1,'창원시','마산합포구','진동면 삼진의거대로 621','삼진로'),(2,'창원시','진해구','경화로16번길 31','경화동'),(3,'창원시','마산합포구','월영동16길 22','월영동'),(4,'하동군','하동읍','군청로 23','하동읍'),(5,'하동군','금성면','금성중앙길 14','금성면'),(6,'김해시','호계로','517번길 8','동상동'),(7,'김해시','활천로','303','삼방동'),(8,'김해시','장유동','능동로 149','장유동'),(9,'김해시','진영읍','김해대로365번길 6-24','진영읍'),(10,'김해시','김해대로','2515','김해대로'),(11,'김해시','진례면','진례로 241','진례면'),(12,'거제시','남부면','저구리 산 116번지','저구리'),(13,'거제시','아주동','산164-1','아주동'),(14,'거제시','계룡로','125','고현동'),(15,'사천시','사천읍','읍내로 52','사천읍'),(16,'사천시','향촌5길','28','향촌동'),(17,'창원시','의창구','대산면 갈전로99번길 100 ','대산면'),(18,'양산시','북안남5길','21','북부동'),(19,'양산시','삼호9길','11','삼호동'),(20,'양산시','물금읍','황산로 384','물금읍'),(21,'밀양시','중앙로','346','내일동'),(22,'통영시','안개4길','53','무전동'),(23,'고성군','고성읍','중앙로 35','고성읍'),(24,'거창군','거창읍','거함대로 3252','거창읍'),(25,'함안군','가야읍','함안대로 505','가야읍'),(26,'함양군','함양읍','고운로 35','함양읍'),(27,'남해군','남해읍','남해대로 2745','남해읍'),(28,'산청군','산청읍','산엔청로 1','산청읍'),(29,'거창군','남상면','인평길 36','남상면'),(30,'의령군','의령읍','의병로8길 44','의령읍'),(31,'창녕군','창녕읍','우포2로 1189-35','창녕읍'),(32,'합천군','합천읍','대야로 888-20','합천읍'),(33,'창원시','성산구','적현로 424','마산항'),(34,'하동군','금성면','경제산업로 509','하동항'),(35,'사천시','향촌동','1292','삼천포항'),(36,'창원시','마산회원구','회원동 11번길 7','회원동'),(37,'창원시','마산회원구','봉양로 148','봉암동'),(38,'창원시','마산회원구','내서읍 광려로 8','내서읍'),(39,'진주시','북장대로64번길','14','상봉동'),(40,'진주시','진주대로','1052','대안동'),(41,'진주시','동진로','279','상대동(진주)'),(42,'진주시','정촌면','예하리 1340','정촌면'),(43,'창원시','의창구','우곡로101번길 28','명서동'),(44,'창원시','성산구','공단로 303','웅남동'),(45,'창원시','성산구','외리로14번길 18','성주동'),(46,'창원시','의창구','용지로 239번길 19-4','용지동'),(47,'창원시','의창구','원이대로 450','반송로'),(48,'창원시','성산구','창이대로 706번길 16-23','사파동');
...
-- Dump completed on 2024-07-14 16:54:07
